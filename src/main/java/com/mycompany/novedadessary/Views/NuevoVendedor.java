...
public class NuevoVendedor extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(NuevoVendedor.class.getName());
    ...
    private void initComponents() {
        ...
        setTitle("Novedades Sary | Nuevo Vendedor");
        setResizable(false);
        ...
        jLabel4.setText("ID del vendedor:");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new NuevoVendedor().setVisible(true));
    }
